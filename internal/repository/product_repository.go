...
func (r *productRepo) FindByID(id string) (model.Product, error) {
	query := `SELECT id, name, description, price, stock, main_category_id, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by FROM products WHERE id = $1`
...
func (r *productRepo) FindByCategory(categoryID string) ([]model.Product, error) {
	query := `SELECT id, name, description, price, stock, main_category_id, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by FROM products WHERE main_category_id = $1`
...
func (r *productRepo) FindByName(name string) ([]model.Product, error) {
	query := `SELECT id, name, description, price, stock, main_category_id, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by FROM products WHERE name ILIKE $1`
...
func (r *productRepo) FindByPriceRange(minPrice, maxPrice float64) ([]model.Product, error) {
	query := `SELECT id, name, description, price, stock, main_category_id, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by FROM products WHERE price BETWEEN $1 AND $2`
...
func (r *productRepo) Create(p model.Product) error {
	query := `INSERT INTO products (name, description, price, stock, main_category_id, created_by) VALUES ($1, $2, $3, $4, $5, $6)`
...
func (r *productRepo) Update(p model.Product) error {
	query := `UPDATE products SET name = $1, description = $2, price = $3, stock = $4, main_category_id = $5, updated_at = $6, updated_by = $7 WHERE id = $8`
...
func (r *productRepo) Delete(id string) error {
	query := `UPDATE products SET deleted_at = NOW(), deleted_by = $1 WHERE id = $2`
